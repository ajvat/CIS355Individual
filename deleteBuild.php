<?php
// filename: deleteBuild.php, Anthony Vatter, cis355, 2015-04-26
// Prompts the user whether or not they want to delete the selected record and does so accordingly
    ...
    if ( !empty($_POST)) {
        ...
        $sql = "DELETE FROM build_details WHERE build_TUID = ?";
        $q = $pdo->prepare($sql);
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="deleteBuild.php" method="post">
                      <input type="hidden" name="deleteid" value="<?php echo $deleteid;?>"/>
							 <input type="hidden" name="id" value="<?php echo $id;?>"/>
                      <p class="alert alert-error">Are you sure you want to delete?</p>
                      <div class="form-actions">
                          <button type="submit" class="btn btn-danger">Yes</button>
                          <a class="btn btn-default" href="readBuilds.php?id=<?php echo $id?>">No</a>
                        </div>
                    </form>
                </div>
