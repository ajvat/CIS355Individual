<?php	
// filename: login.php, Anthony Vatter, cis355, 2015-04-26
// sets the $_SESSION email variable to "loggedin" to log in the user
	session_start();
	...
	if(isset($_POST['loginSubmit'])) // If the user pressed the Submit button
	{
		...
		{
		    $_SESSION["email"] = $sess_id;
			// If the user came from the login page, direct them to the landing page
			if ($_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~ajvatter/inClass/index.php" 
			    || $_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~ajvatter/inClass/login.php" )
			{
